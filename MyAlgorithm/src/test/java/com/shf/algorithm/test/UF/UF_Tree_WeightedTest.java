package com.shf.algorithm.test.UF;

import com.shf.algorithm.uf.UF_Tree;
import com.shf.algorithm.uf.UF_Tree_Weighted;
...
//        创建并查集对象
        ...
        System.out.println("默认情况下，并查集有："+uf.count()+"个分组");
